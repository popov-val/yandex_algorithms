...
-- ВРЕМЕННАЯ СЛОЖНОСТЬ --
Кол-во документов - N
Кол-во слов в документе - L
Кол-во слов в запросе - K, кол-во уникальных: лучший случай - 1, худший K
1) Сбор поискового индекса
    O(N*L) - Прохождение по каждому слову каждого документа
    O(1) - Добавление к словарю каждого слова
Итого: ~ O(N*L)
...
Итого: ~ O(K*N) на каждый запрос

-- ПРОСТРАНСТВЕННАЯ СЛОЖНОСТЬ --
Кол-во документов - N
Кол-во слов в документе - L, кол-во уникальных: лучший случай - 1, худший L
Кол-во слов в запросе - K, кол-во уникальных: лучший случай - 1, худший K
1) Сбор поискового индекса - O(L*N) для каждого уникального слова словарь с кол-вом документов
2) Поиск и расчет релевантности на каждый запрос O(N) + O(K) на структуру релевантности
